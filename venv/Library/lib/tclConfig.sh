...
# installed.
TCL_PREFIX='C:/python notes/python.py/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/python notes/python.py/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/python notes/python.py/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/python notes/python.py/venv\Library\include'
...
TCL_PACKAGE_PATH='C:/python notes/python.py/venv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/python notes/python.py/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/python notes/python.py/venv\Library\lib\tclstub86.lib'
